    ...
    public class ProductoRepositoryImpl : IProductoRepository
    {
        ...
        public ProductoRepositoryImpl()
        {
            cn = ConfigurationManager
                .ConnectionStrings["EjemploMVVM.Properties.Settings.NorthwindDB"]
                .ConnectionString;
        }

        public List<Producto> BuscarPorNombre(string nombre)
        {
            string query = "SELECT ProductID, ProductName, UnitPrice, Discontinued " +
                           "FROM Products " +
                           "WHERE (@Nombre IS NULL OR ProductName LIKE @Nombre)";
        ...
        public Dictionary<int, string> ListarCategorias()
        {
            string query =
